...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 18 sep 2017 kl 18:06
...
(3, '9405034670', '9789146233794', '2017-09-18', '2017-09-18');
...
CREATE TABLE `user` (
  ...
  `user-lvl` int(3) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `user` (`ssn`, `name`, `username`, `password`, `user-lvl`) VALUES
('9405034670', 'max Timje', 'theSwedishScout', '$2y$08$Ec5D.vor0Rzh7JW6w0EKoeDaq64AgdR3cjI/tACej8Y7D22hAbsxG', 0);
